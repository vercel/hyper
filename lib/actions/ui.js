...
export function showPreferences() {
  const editorFallback = process.platform === 'win32' ? 'nano' : 'notepad';
  const command = process.platform === 'win32' ? ' start notepad "%userprofile%\\.hyper.js"' : ' bash -c \'exec env ${EDITOR:=' + editorFallback + '} ~/.hyper.js\'';
