...
export default class Term extends Component {
  ...
  componentDidMount() {
    ...
    prefs.set('font-weight', props.fontWeight);
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (this.props.fontWeight !== nextProps.fontWeight) {
      prefs.set('font-weight', nextProps.fontWeight);
      this.hyperCaret.style.fontWeight = nextProps.fontWeight;
    }
