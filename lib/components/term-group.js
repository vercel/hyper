...
TermGroup_.propTypes = {
  backgroundColor: PropTypes.string,
  bell: PropTypes.string,
  bellSoundURL: PropTypes.string,
  borderColor: PropTypes.string,
  childGroups: PropTypes.object,
  colors: PropTypes.object,
  copyOnSelect: PropTypes.bool,
  cursorColor: PropTypes.string,
  cursorShape: PropTypes.string,
  customCSS: PropTypes.object,
  fontFamily: PropTypes.string,
  fontSize: PropTypes.number,
  fontSmoothing: PropTypes.number,
  foregroundColor: PropTypes.string,
  modifierKeys: PropTypes.string,
  onActive: PropTypes.func,
  onData: PropTypes.func,
  onResize: PropTypes.func,
  onTermGroupResize: PropTypes.func,
  onTitle: PropTypes.func,
  onURLAbort: PropTypes.func,
  padding: PropTypes.string,
  ref_: PropTypes.func,
  sessions: PropTypes.object,
  termGroup: PropTypes.object,
