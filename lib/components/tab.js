...
export default class Tab extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (
      ...
      this.props.lastActivity !== nextProps.lastActivity &&
      !this.state.flashing &&
      now - this.state.lastFlashing > 1000
    ) {
      this.setState({flashing: true, lastFlashing: now});
    }
  }
  ...
  styles() {
    return {
      ...
      flashing: {
        textShadow: '0 0 1em #50E3C2, 0 0 1em #50E3C2, 0 0 1em #50E3C2'
      },
