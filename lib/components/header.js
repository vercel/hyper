          ...
          >
            ...
            {winCtrls && (
              <div className={`header_windowControls ${left ? 'header_windowControlsLeft' : ''}`}>
                <svg className={`header_shape ${left && 'header_minimizeWindowLeft'}`} onClick={this.handleMinimizeClick}>
                  <use xlinkHref="./renderer/assets/icons.svg#minimize-window" />
                </svg>
                <svg className={`header_shape ${left && 'header_maximizeWindowLeft'}`} onClick={this.handleMaximizeClick}>
                  <use xlinkHref={maxButtonHref} />
                </svg>
                <svg className={`header_shape header_closeWindow ${left && 'header_closeWindowLeft'}`} onClick={this.handleCloseClick}>
