...
export default class Header extends React.PureComponent {
  ...
  render() {
    ...
    const pinnedButtonHref = this.props.pinned
      ? './renderer/assets/icons.svg#pinned-window'
      : './renderer/assets/icons.svg#pin-window';
          ...
          >
            ...
            {winCtrls && (
              <div className={`header_windowControls ${left ? 'header_windowControlsLeft' : ''}`}>
                <div className={`${left ? 'header_pinWindowLeft' : ''}`} onClick={this.handlePinClick}>
                  <svg className="header_shape">
                    <use xlinkHref={pinnedButtonHref} />
                  </svg>
                </div>
