...
Notifications.propTypes = {
  ...
  fontShowing: PropTypes.bool,
  fontSize: PropTypes.string,
  messageDismissable: PropTypes.bool,
  messageShowing: PropTypes.bool,
  messageText: PropTypes.string,
  messageURL: PropTypes.string,
  onDismissFont: PropTypes.func,
  onDismissMessage: PropTypes.func,
  onDismissResize: PropTypes.func,
  onDismissUpdate: PropTypes.func,
  onUpdateInstall: PropTypes.func,
  resizeShowing: PropTypes.bool,
