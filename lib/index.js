...
rpc.on('broadcast all req', () => {
  store_.dispatch(sessionActions.setBroadcast('all'));
});

rpc.on('broadcast current tab req', () => {
  store_.dispatch(sessionActions.setBroadcast('tab'));
});

rpc.on('broadcast one req', () => {
  store_.dispatch(sessionActions.setBroadcast('one'));
});
