...
class Hyper extends Component {
  ...
  attachKeyListeners() {
    const {moveTo, moveLeft, moveRight, moveToPane} = this.props;
    const term = this.terms.getActiveTerm();
    if (!term) {
      return;
    }
    ...
    keys.bind('mod+ctrl+1', moveToPane.bind(this, 1));
    keys.bind('mod+ctrl+2', moveToPane.bind(this, 2));
    keys.bind('mod+ctrl+3', moveToPane.bind(this, 3));
    keys.bind('mod+ctrl+4', moveToPane.bind(this, 4));
    keys.bind('mod+ctrl+5', moveToPane.bind(this, 5));
    keys.bind('mod+ctrl+6', moveToPane.bind(this, 6));
    keys.bind('mod+ctrl+7', moveToPane.bind(this, 7));
    keys.bind('mod+ctrl+8', moveToPane.bind(this, 8));
    keys.bind('mod+ctrl+9', moveToPane.bind(this, 9));
...
const HyperContainer = connect(
  ...
  dispatch => {
    return {
      ...
      moveToPane: i => {
        dispatch(uiActions.moveToPane(i));
      }
    };
  },
  null,
